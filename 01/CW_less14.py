...
#шаблончик для визначення класу
...
for file in files:
    ...
    if found:
        ...
        cv2.putText(boxed, f'person: {conf:.2f}', (x1, y1-10), cv2.FONT_HERSHEY_SIMPLEX, 1.0, (0, 0, 255), 2)
